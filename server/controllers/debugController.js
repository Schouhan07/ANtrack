...
exports.getApiCatalog = (req, res) => {
  ...
  res.json({
    ...
    endpoints: [
      ...
      { method: 'GET', path: '/api/metrics/platform-analytics', description: 'Instagram vs TikTok rollup (JSON)' },
      ...
      { method: 'GET', path: '/api/metrics/creator-scores', description: 'Creator content scores + raw signals' },
